...
function get_account_date() //FIGURE THIS SHIT OUT 
{
    if (is_logged_in() && isset($_SESSION["user_id"]["account_number"])) {
        //return (string)se($_SESSION["user_id"]["account_number"], "created", 0, false);
        $date = "SELECT CURRENT_TIMESTAMP FROM Accounts";
        return $date;
    }
    return 0;
}